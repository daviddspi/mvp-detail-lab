  ...
  const scrollToSection = (e: React.MouseEvent<HTMLAnchorElement>, href: string) => {
    if (href.startsWith('#')) {
      ...
      if (element) {
        ...
        setTimeout(() => {
          const navbarHeight = isScrolled ? 80 : 110;
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-10 flex justify-between items-center">
          ...
          {/* Desktop Nav Items */}
          <nav className="hidden lg:flex items-center gap-10" aria-label="Glavna navigacija">
            {navLinks.map((link) => (
              <div 
                key={link.name} 
          ...
          <div className="flex items-center gap-6 md:gap-8">
            <a
              ...
              className="hidden lg:flex bg-white hover:bg-black hover:text-white active:scale-95 text-black px-8 py-4 rounded-none text-[12px] font-black tracking-[0.2em] transition-all transform flex items-center justify-center border border-white shadow-xl"
            >
              ZAKAŽI TERMIN
            </a>
              ...
              <div className="p-8 flex flex-col gap-2">
                ...
                <div className="mt-4 pt-4 border-t border-white/5 flex justify-center">
                  <a
                    href="#contact"
                    onClick={(e) => scrollToSection(e, '#contact')}
                    className="px-12 bg-primary text-black py-4 rounded-none font-black tracking-[0.2em] uppercase text-center shadow-primary-glow text-xs hover:bg-white active:scale-95 transition-all"
                  >
                    ZAKAŽI
                  </a>
                </div>
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-4">
            <div className="flex items-center gap-1.5 px-4 py-1.5 bg-primary/20 backdrop-blur-md rounded-none border border-primary/20">
              ...
              <span className="text-xs font-bold text-primary">Premium Detailing Studio</span>
            </div>
          </div>
          ...
          <p className="text-white/50 text-[13px] md:text-[15px] mb-12 md:mb-16 max-w-2xl mx-auto leading-relaxed text-balance">
            ...
            Ovde u {BUSINESS_CONFIG.stats[2].value}u svakom detalju prilazim sa maksimalnom posvećenošću i ljubavlju prema svom poslu.
          </p>
          ...
          >
            ...
            <div className="flex flex-col text-left">
              ...
              <p className="text-[11px] font-bold text-primary tracking-wide leading-tight">
                {BUSINESS_CONFIG.stats[1].value} Verifikovanih recenzija
              </p>
            </div>
          </motion.div>
          ...
          <div className="hidden md:flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 w-full md:w-auto mb-12 md:mb-0 mt-auto md:mt-0">
            <motion.a 
              ...
              className="w-full md:w-auto md:h-16 bg-white hover:bg-white/90 active:scale-95 text-black px-10 py-4 md:py-0 rounded-none font-black tracking-[0.25em] uppercase text-[11px] transition-all transform hover:scale-105 flex items-center justify-center gap-3 shadow-xl relative overflow-hidden group"
            >
              <span className="relative z-10 flex items-center gap-3">
                ZAKAŽI TERMIN <ArrowRight className="w-5 h-5 text-black group-hover:translate-x-1 transition-transform" aria-hidden="true" />
              </span>
              <motion.div 
...
const MarqueeStats = () => {
  ...
  // Create a flat list of text and diamonds for perfect spacing
  const marqueeItems = [];
  [...services, ...services, ...services, ...services].forEach((service) => {
    marqueeItems.push({ type: 'text', content: service });
    marqueeItems.push({ type: 'divider' });
  });

  return (
    <section className="bg-white border-y border-black/5 py-5 md:py-8 overflow-hidden relative z-20">
      <motion.div 
        animate={{ x: [0, -1800] }}
        transition={{ duration: 40, repeat: Infinity, ease: "linear" }}
        className="flex items-center gap-10 md:gap-16 whitespace-nowrap w-fit px-10"
      >
        {marqueeItems.map((item, idx) => (
          item.type === 'text' ? (
            <span key={idx} className="text-xl md:text-3xl font-black italic tracking-tighter uppercase text-black leading-none">
              {item.content}
            </span>
          ) : (
            <div key={idx} className="w-1.5 h-1.5 bg-black rotate-45 shrink-0" />
          )
        ))}
      </motion.div>
    </section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 auto-rows-auto md:auto-rows-[220px]">
          ...
          >
            ...
            <div className="mt-auto w-full sm:w-auto">
              <a 
                href="#contact" 
                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-white text-black px-8 md:px-10 py-4 md:py-5 font-black tracking-[0.25em] uppercase text-[11px] hover:bg-black hover:text-white transition-all active:scale-95 group/btn"
              >
                Rezerviši Termin
...
const Gallery = () => {
  ...
  const items = [
    { type: 'video', src: '/gallery/mvpgallery/AQOJVRhvg8umhk_Mx5lDgPrndemE53tNWTGWDG1H-UF7G8yr88O9CFf1FdJptkqS1T2bvU16mZnRUMyyzCQih5VyknAYPGMK.mp4', label: 'Premium Detailing Proces', size: 'lg' },
    { type: 'image', src: '/gallery/mvpgallery/619247731_17862105327571160_3525610967196535988_n..jpg', label: 'Ekskluzivna Nega Laka', size: 'sm' },
    { type: 'image', src: '/gallery/mvpgallery/602219656_17857524816571160_7676489064028078170_n..jpg', label: 'Interior Detailing', size: 'sm' },
    { type: 'video', src: '/gallery/mvpgallery/AQOO4SiNLAMEzRX9_QZKwVmCMIJfJyIsW29zGqf-KPOrNVlFHlNgd-P3T1nq1KjE47pn-fCyXJUqvtMR-e-NoC3nam86EIlw.mp4', label: 'Proces Penjenja', size: 'sm' },
    { type: 'image', src: '/gallery/mvpgallery/603068412_17857952922571160_7553494425575373826_n..jpg', label: 'Vrhunski Sjaj', size: 'lg' },
    { type: 'image', src: '/gallery/mvpgallery/605569927_17858617833571160_2939226275577996357_n..jpg', label: 'Finalna Inspekcija', size: 'sm' },
    { type: 'image', src: '/gallery/mvpgallery/619515854_17862105306571160_1666985187718715846_n..jpg', label: 'Perfekcija u Svakom Detalju', size: 'sm' },
    { type: 'image', src: '/gallery/mvpgallery/605957835_17858617872571160_5233479196999967753_n..jpg', label: 'Studio Rezultat', size: 'sm' },
    { type: 'image', src: '/gallery/mvpgallery/603955396_17857953303571160_5933825308799513817_n..jpg', label: 'MVP Standard Detailinga', size: 'sm' },
  ];
  ...
  return (
    ...
    >
      <div id="gallery" className="scroll-mt-28"></div>
            ...
            >
              {item.type === 'video' ? (
                <div className="w-full h-full relative">
                  ...
                  />
                  <div className="absolute top-4 right-4 z-10 w-10 h-10 bg-black/50 backdrop-blur-md flex items-center justify-center border border-white/10 group-hover:bg-primary transition-colors">
                ...
                <img
                  src={item.src}
                  alt={`${BUSINESS_CONFIG.name} - ${item.label}`}
...
const Testimonials = () => {
  ...
  return (
    <motion.section 
      ...
      viewport={{ once: true }}
      transition={{ duration: 1 }}
      className="py-12 sm:py-24 bg-secondary relative overflow-hidden" 
    >
      <div id="testimonials" className="scroll-mt-28"></div>
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="relative w-full h-[480px] sm:h-[600px] flex items-center overflow-hidden">
          {/* Shadow Overlays */}
...
const PricingCard = ({ plan, idx, vehicleClass }: any) => {
  ...
  return (
    <motion.div 
      ...
      className={`relative p-8 h-fit rounded-none border transition-all duration-500 hover:-translate-y-3 flex flex-col group/card shadow-xl hover:shadow-[0_20px_50px_-20px_rgba(0,0,0,0.5)] ${
        isBasic 
          ...
          : isVip
            ...
            : plan.recommended
              ? 'bg-surface/40 md:backdrop-blur-md border-primary/40 text-white shadow-[0_0_30px_rgba(47,52,153,0.15)] hover:border-primary/60 ring-1 ring-primary/20 z-10'
              : 'bg-surface/40 md:backdrop-blur-md border-white/10 hover:border-white/40 text-white'
      }`}
    >
      {plan.badge && (
...
const Pricing = () => {
  ...
  return (
    <motion.section 
      ...
      className="py-24 bg-secondary relative overflow-hidden"
    >
      <div id="packages" className="scroll-mt-28"></div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-16" aria-label="Izbor kategorije vozila">
            {classes.map((className, idx) => (
              <button
                key={idx}
                onClick={() => setVehicleClass(idx)}
                aria-pressed={vehicleClass === idx}
                className={`px-8 py-4 rounded-none font-black tracking-widest uppercase text-xs transition-all border ${
                  vehicleClass === idx 
                    ? 'bg-white border-white text-black shadow-xl ring-4 ring-white/10' 
        ...
        <div className="mt-32 w-full">
          <div className="bg-surface/40 md:backdrop-blur-md border border-white/10 rounded-none p-10 md:p-14 flex flex-col lg:flex-row items-center gap-10 md:gap-14 text-center lg:text-left transition-colors duration-500 hover:border-primary/50 group shadow-2xl">
            ...
            <div className="shrink-0 w-full lg:w-auto">
              <a 
                href="#contact"
                className="w-full lg:w-auto bg-white text-black px-10 py-5 rounded-none font-black tracking-[0.25em] uppercase text-[11px] flex items-center justify-center gap-3 transition-all duration-300 hover:bg-black hover:text-white border border-white shadow-xl active:scale-95 group/btn"
              >
...
const Contact = () => {
  ...
  return (
    <motion.section 
      ...
      className="py-24 bg-secondary relative overflow-hidden"
    >
      <div id="contact" className="scroll-mt-28"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-start">
          ...
          <div className="order-3 lg:col-start-1 lg:row-start-2">
            ...
            <div className="mt-8 flex items-center gap-4 text-white/10 justify-center lg:justify-start">
               ...
               <span className="text-[9px] font-bold uppercase tracking-[0.3em]">{BUSINESS_CONFIG.name} {new Date().getFullYear()}</span>
               <div className="h-px flex-1 bg-white/5" />
            </div>
          </div>
          ...
          {faqs.map((faq, idx) => (
            ...
            >
              ...
              >
                ...
                <div className={`w-10 h-10 shrink-0 border rounded-none flex items-center justify-center transition-all duration-500 ${openIdx === idx ? 'border-white bg-white text-black rotate-45' : 'border-white/20 text-white/50 bg-transparent group-hover:border-white/50'}`}>
  ...
  <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-secondary/95 backdrop-blur-xl border-t border-white/10 px-2 py-3 flex gap-2 safe-area-inset-bottom">
    {BUSINESS_CONFIG.contact.phones.map((phone, idx) => (
      <a
        key={idx}
        href={`tel:${phone}`}
        className="flex-1 bg-white border border-white text-black py-3 rounded-none font-black tracking-tighter uppercase text-[10px] text-center flex flex-col items-center justify-center active:scale-95 transition-transform"
        aria-label={`Pozovi ${idx + 1}`}
      >
        <Phone className="w-3.5 h-3.5 mb-1" aria-hidden="true" /> {phone}
      </a>
    ))}
    <a
      href="#contact"
      className="flex-[1.5] bg-primary text-black py-3 rounded-none font-black tracking-widest uppercase text-xs flex items-center justify-center gap-2 active:scale-95 transition-transform shadow-primary-glow"
    >
      ZAKAŽI <ArrowRight className="w-4 h-4" aria-hidden="true" />
    </a>
  </div>
);
